package ec.edu.uce.GalagaGameProject.Model;

import ec.edu.uce.GalagaGameProject.Controller.GameContainer;
import ec.edu.uce.GalagaGameProject.Model.Interfaces.*;
...
public class Hero implements IDrawable, IMovable, IShootable, IDieable, IUsername, IScore, ILife {
    ...
    @Autowired
    public Hero(@Qualifier("gameContainer") GameContainer gameContainer) {
